    ...
    >
      ...
      <details className={styles.rules}>
        ...
        <section>
          <h3>5. 연결이 끊겼을 때</h3>
          <p>
            연결 단절이 감지되면 마감 전 제출한 표는 제거됩니다. 방이 유지되고 30초 안에 같은
            사용자로 돌아오면 참여 상태를 복구할 수 있지만, 이전 표는 자동 복원되지 않습니다. 현재
            차례에 투표할 수 있다면 다시 제출해 주세요. 재접속을 기다리는 동안에도 게임 시간은
            흐릅니다.
          </p>
          <p>
            방장의 퇴장이나 연결 단절이 감지되면 접속 중인 Member 중 먼저 입장한 사람이 즉시 방장을
            이어받고 모든 Ready가 해제됩니다. 이전 방장이 돌아와도 방장 권한은 자동으로 돌아오지
            않습니다. 이어받을 Member가 없으면 방이 종료됩니다.
          </p>
          <p>
